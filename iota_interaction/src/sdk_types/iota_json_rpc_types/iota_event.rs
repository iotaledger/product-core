...
use super::super::iota_types::base_types::{IotaAddress, ObjectID, TransactionDigest};
use super::super::iota_types::event::EventID;
use super::super::iota_types::iota_serde::{BigInt, IotaStructTag};
...
pub struct IotaEvent {
  ...
  /// 2) Also serves to sequence events for the purposes of pagination and querying. A higher id is an event seen later
  ///    by that fullnode.
...
pub enum EventFilter {
  ...
  MoveEventType(#[serde_as(as = "IotaStructTag")] StructTag),
