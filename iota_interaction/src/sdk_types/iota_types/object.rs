...
#[derive(Eq, PartialEq, Debug, Clone, Copy, Deserialize, Serialize, Hash, Ord, PartialOrd, JsonSchema)]
pub enum Owner {
...
impl Owner {
  ...
  pub fn get_address_owner_address(&self) -> IotaResult<IotaAddress> {
    match self {
      ...
      Self::Shared { .. } | Self::Immutable | Self::ObjectOwner(_) => Err(IotaError::UnexpectedOwnerType),
    }
  }
