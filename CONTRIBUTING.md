# Contribute to product-core

This document describes how to contribute to product-core.
...
- **Ensure the bug was not already reported** by searching on GitHub under [**Issues**](https://github.com/iotaledger/product-core/issues). If the bug has already been reported **and the issue is still open**, add a comment to the existing issue instead of opening a new one.

**Note:** If you find a **Closed** issue that seems similar to what you're experiencing, open a new issue and include a link to the original issue in the body of your new one.

### Submitting a bug report

To report a bug, [open a new issue](https://github.com/iotaledger/product-core/issues/new), and be sure to include as many details as possible, using the template.
...
**Ensure the feature has not already been suggested** by searching on GitHub under [**Issues**](https://github.com/iotaledger/product-core/issues).

### Suggesting a new feature

To suggest a new feature,
* talk to the IOTA community and IOTA Foundation members in the #identity-discussion channel on [Discord](https://discord.gg/iota-builders)
in the `identity-dev` channel.
* open a [Feature Request](https://github.com/iotaledger/product-core/issues/new?template=feature_request.yml).
...
Make sure to discuss the feature in on [Discord](https://discord.iota.org/) in the `identity-dev` channel.
